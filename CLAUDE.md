...
### 2026-05-08: 양조장 유료 정책 = 3-tier (기본 등재 / 공식 인증 / 분석 & 홍보)
4-28 "솔직 모드" 위에 한 단계 더 구체화. 양조장 입장에서 "어디까지 무료, 어디부터 유료" 가
한눈에 보여야 outreach 통과율이 올라간다는 판단.

- **기본 등재** (default, 신청 불필요) — 모든 양조장 자동. 카탈로그·검색·체크인·schema.org.
- **공식 인증** (양조장 운영자 인증, **앞으로도 무료**) — Verified 뱃지·이야기 등재·사진 업로드·
  제품 정보 수정·체크인 답변. 정식 출시 후에도 영구 무료. 커뮤니티 자산 정신.
- **분석 & 홍보** (개발 중, 정식 출시 시 유료) — 조회수/체크인 통계·신제품 우선 노출·공지 뉴스피드·
...
### 2026-05-08: 양조장 cohort 한국어 표기 = "1기 양조장"
- 외래어 "cohort" 대신 한국어 "1기 양조장" / "1기 회원" 으로 통일. tier 명칭도 영어 (Free /
  Verified / Pro) 대신 "기본 등재 / 공식 인증 / 분석 & 홍보" 한국어.
