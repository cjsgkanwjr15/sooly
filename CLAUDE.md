...
### 2026-05-08: 양조장 유료 정책 = 3-tier (기본 / 공식 / 비즈니스)
4-28 "솔직 모드" 위에 한 단계 더 구체화. 양조장 입장에서 "어디까지 무료, 어디부터 유료" 가
한눈에 보여야 outreach 통과율이 올라간다는 판단.

- **기본** (default, 신청 불필요) — 모든 양조장 자동. 카탈로그·검색·체크인·schema.org.
- **공식** (양조장 운영자 본인 확인, **앞으로도 무료**) — 공식 ✓ 뱃지·이야기 등재·사진 업로드·
  제품 정보 수정·체크인 답변. 정식 출시 후에도 영구 무료. 커뮤니티 자산 정신.
- **비즈니스** (개발 중, 정식 출시 시 유료) — 조회수/체크인 통계·신제품 우선 노출·공지 뉴스피드·
  검색 키워드 리포트. 가격은 1기 양조장 5~10곳과 협의 후 확정.

가격을 미리 못 박지 않는 이유는 4-28 결정 그대로. 다만 **"무엇이 영구 무료, 무엇이 유료가 될
가능성"** 만큼은 미리 분리해서 보여줘야 양조장이 "지금 가입했다 나중에 강제 유료 전환되는 거
아냐?" 의심 차단. FAQ 에 직접 문답으로도 명시.

### 2026-05-08: 양조장 tier·cohort 어휘 = 한국어 + 명사형
- 외래어 "cohort" 대신 한국어 "1기 양조장". tier 명칭도 영어 (Free / Verified / Pro) 대신 한국어
  명사형 "**기본 / 공식 / 비즈니스**" (가운데 단계는 "인증" 대신 "공식" — Kim 결정. 뱃지 "공식 ✓"
  와 tier name 일치 + 톤 brand-y).
- 이유: 한국 양조장 사장님 (5060대 다수) 주 타겟에 외래어 톤은 비즈니스 어필 ↓. "1기 양조장"
...
- 정식 출시 시 6개월 무료
- 평생 가격 락인 (가격 인상돼도 처음 정한 가격 유지)
- 1기 양조장 표기 (양조장 페이지·Sooly 공식 채널)
